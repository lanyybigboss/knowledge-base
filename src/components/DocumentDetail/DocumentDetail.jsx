  ...
  const handleReAnalyze = async () => {
    ...
    try {
      ...
      if (result._fallback) {
        ...
        await updateDocument(doc.id, { _aiAttemptedAt: Date.now() })
        showNotification('warning', 'AI 分析失败，已有分析结果已保留')
        setAnalyzing(false)
        return
      }
      ...
      if (!hasValidSummary && !hasValidKeywords) {
        await updateDocument(doc.id, { _aiAttemptedAt: Date.now() })
        showNotification('warning', 'AI 返回结果无效，已有分析结果已保留')
        setAnalyzing(false)
        return
      }
      ...
      <div className="document-detail-content">
        ...
        <div className="document-detail-main">
          ...
          <div className="card">
            ...
            {doc.detailedSummary ? (
              <div className="document-detail-detailed-summary">
                <p>{doc.detailedSummary}</p>
              </div>
            ) : doc.summary ? (
                  ...
                  <div className="document-detail-entity-group">
                    ...
                    <div className="document-detail-entity-tags">
                      {entities.people.map((person, i) => (
                        <span key={i} className="tag tag-entity">{person}</span>
                      ))}
                    </div>
                  </div>
                )}
                  ...
                  <div className="document-detail-entity-group">
                    ...
                    <div className="document-detail-entity-tags">
                      {entities.organizations.map((org, i) => (
                        <span key={i} className="tag tag-entity">{org}</span>
                      ))}
                    </div>
                  </div>
                )}
                  ...
                  <div className="document-detail-entity-group">
                    ...
                    <div className="document-detail-entity-tags">
                      {entities.locations.map((loc, i) => (
                        <span key={i} className="tag tag-entity">{loc}</span>
                      ))}
                    </div>
                  </div>
                )}
                  ...
                  <div className="document-detail-entity-group">
                    ...
                    <div className="document-detail-entity-tags">
                      {entities.dates.map((date, i) => (
                        <span key={i} className="tag tag-entity">{date}</span>
                      ))}
                    </div>
                  </div>
                )}
