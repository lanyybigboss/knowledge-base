...
├── data/                   # 用户数据 (~206 MB)
├── ForAi/                  # AI 长期记忆 (联接到 E:\Obsidian\ForAi)
└── obsidian-vault/         # Obsidian 笔记库
    └── Obsidian-SecondBrain/  # 第二大脑笔记
```

## 关键文件
- [AGENTS.md](file:///e:/O1/AGENTS.md) - AI 行为规则
- [CLAUDE.md](file:///e:/O1/CLAUDE.md) - 项目约定
- [知识库管理系统-开发文档.md](file:///e:/O1/知识库管理系统-开发文档.md) - 开发记录
...
- [[编码规范与约定]] - 技术栈、编码规范、ESLint 配置
- [[AgentSkills技能体系]] - 技能框架和调用规范
- [[知识库管理最佳实践]] - 知识组织和维护指南
